...
LIBRARY_FLAGS := -lm -lpthread -Lbuild/deps/allegro5/lib -lallegro -lallegro_primitives -lallegro_font -lallegro_audio -lallegro_ttf -lallegro_image -lallegro_acodec -lallegro_color -Wl,-rpath,./deps/allegro5
