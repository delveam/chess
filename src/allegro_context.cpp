...
std::any AllegroContext::get_keyboard_state_impl(std::any state)
{
    ALLEGRO_KEYBOARD_STATE* test = std::any_cast<ALLEGRO_KEYBOARD_STATE*>(state);
    al_get_keyboard_state(test);
